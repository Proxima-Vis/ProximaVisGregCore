...
public class PVBotaniaMaterials {
    ...
    public static void register() {
        MANASTEEL = regmat("manasteel", "shiny", 0x4c82a9, 0x171781).ingot()
        ...
        MANA_DIAMOND = regmat("mana_diamond", "shiny", 0xcdfef8, 0x80b9c4).gem()
        ...
        MANA_PEARL = regmat("mana_pearl", "shiny", 0x80d9e1, 0x80b9c4).gem()
        ...
        MANA_QUARTZ = regmat("mana_quartz", "quartz", 0xcde5ee, 0x9bc4d5).gem()
        ...
        TERRASTEEL = regmat("terrasteel", "shiny", 0x51ac49, 0x032d15).ingot()
        ...
        ELEMENTIUM = regmat("elementium", "shiny", 0xae647d, 0x31054e).ingot()
        ...
        DRAGONSTONE = regmat("dragonstone", "shiny", 0xe782b2, 0x5b2474).gem()
        ...
        PIXIE_DUST = regmat("pixie_dust", "shiny", 0xf09faa, 0x5b2474).dust()
        ...
        ELEMENTIUM_QUARTZ = regmat("elementium_quartz", "quartz", 0xda4fd7, 0xb407a8).gem()
        ...
        LIFE_ESSENCE = regmat("life_essence", "shiny", 0xedfbed, 0xa7eea8).gem()
        ...
        GAIASTEEL = regmat("gaiasteel", "shiny", 0xedfbed, 0xa7eea8).ingot()
                .components(LIFE_ESSENCE, 4, TERRASTEEL, 1)
                .buildAndRegister();
        PVIgnore.ignoreForms(GAIASTEEL, Map.of(
                "ingot", () -> BotaniaItems.gaiaIngot));

        AERIALITE = regmat("aerialite", "shiny", 0x077ea1, 0x012749).ingot()
        ...
        PHOTONIUM = regmat("photonium", "shiny", 0xe8e8e8, 0x696868).ingot()
                .components(ELEMENTIUM, 1)
                .buildAndRegister();
        PVIgnore.ignoreForms(PHOTONIUM, Map.of(
                "ingot", () -> ExtraBotanyItems.photonium,
                "nugget", () -> ExtraBotanyItems.photoniumNugget,
                "block", () -> ExtraBotanyBlocks.photoniumBlock));

        SHADOWIUM = regmat("shadowium", "shiny", 0x787878, 0x464646).ingot()
                .components(ELEMENTIUM, 1)
                .buildAndRegister();
        PVIgnore.ignoreForms(SHADOWIUM, Map.of(
                "ingot", () -> ExtraBotanyItems.shadowium,
                "nugget", () -> ExtraBotanyItems.shadowiumNugget,
                "block", () -> ExtraBotanyBlocks.shadowiumBlock));

        ORICHALCOS = regmat("orichalcos", "shiny", 0x7e23e0, 0xef7709).ingot()
                .components(GAIASTEEL, 2, LIFE_ESSENCE, 4)
                .buildAndRegister();
        PVIgnore.ignoreForms(ORICHALCOS, Map.of(
                "ingot", () -> ExtraBotanyItems.orichalcos,
                "nugget", () -> ExtraBotanyItems.orichalcosNugget,
                "block", () -> ExtraBotanyBlocks.orichalcosBlock));
    };
}
